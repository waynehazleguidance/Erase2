...
class DemoCest extends \Guidance\Tests\Base\Test\BaseAbstract
{
   ...
   //     $I->reloadPage();
    ...
    // **********************************
    public function ShopElle(\Guidance\Tests\Project\Actor $I)
    {
    ...
    public function ShopMarieClaire(\Guidance\Tests\Project\Actor $I)
    {
    ...
    public function ShopMensHealth(\Guidance\Tests\Project\Actor $I)
    {
        ...
        // *****************************************************************************
        //  Go to PDP and Add to Shopping Cart
        // ***********************************************************
        $I->amOnPage('/backslash-fit-smart-mat-option.html');
        $I->see('Mat');
...
{
    // No content Except front opage
    $I->amOnUrl('https://www.housebeautiful.com/');
    $I->see('Subscribe');
