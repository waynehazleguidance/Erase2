...
class DemoCest extends \Guidance\Tests\Base\Test\BaseAbstract
{
    ...
    public function ShopVeranda(\Guidance\Tests\Project\Actor $I)
    {


        $I->amOnUrl('https://shop.verdanda.com/');
        $I->reloadPage();
        $I->see('Veranda');
    ...
    public function _cityChicTest(\Guidance\Tests\Project\Actor $I)
    {
...
//        $I->see($productTitle);
     ...
     * @group InsectLore
     */
    public function _insectLoreTest(\Guidance\Tests\Project\Actor $I)
    {
